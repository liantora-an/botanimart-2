...
import { Leaf, ArrowLeft, Sparkles, HeartHandshake, ShieldCheck } from 'lucide-react';
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-end p-16 text-white">
          <div className="glass-panel p-8 rounded-3xl animate-fade-in-up border border-white/10 shadow-2xl">
            ...
            <p className="text-white/80 text-sm md:text-base leading-relaxed mb-6">
              Mulai perjalanan Anda sekarang. Dapatkan akses ke penawaran eksklusif, rekomendasi tanaman kustom, dan konsultasi perawatan gratis.
            </p>
